...
exportMap(ws_2019, 'data/basemap_nl_provinces.svg', 'nl/nl_ws_p.svg', candidaciesData=candidaciesData)
exportMap(ws_2019, 'data/basemap_nl_gemeinden_2021.svg', 'nl/nl_ws_g.svg', candidaciesData=candidaciesData)
