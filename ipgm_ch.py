...
nrw_2023.renameCandidate('FGA', 'AL')
...
if doExportMap:
	...
	exportMap(nrw_2023, 'data/ch/maps/districts_2023.svg', f'{poll}/{"nrw_2023"}_districts.svg', candidaciesData=candidaciesData)
	print('District map exported')
	exportMap(nrw_2023, 'data/ch/maps/gemeinds_2023.svg', f'{poll}/{"nrw_2023"}_gemeinds.svg', candidaciesData=candidaciesData)
