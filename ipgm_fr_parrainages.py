...
exportSeatsMap(r, r.exportDict(), seatsData, 'data/basemap_collectivites_parrainages.svg', '{path}/{h}_parrainages.svg'.format(h=hk, path=poll), allDivs=allDivs, candidaciesData=candidaciesData, seatsScale=1.6, mapScaling=3, sameParty=False)
