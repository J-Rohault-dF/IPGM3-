...
exportMap(t1_2020, 'data/paris/maps/bureaux_de_vote.svg', 'Paris_2020/2020T1_b.svg', candidaciesData=candidaciesData)
...
for candidate in candidatesList:
	...
	exportMap(t1_2020, 'data/paris/maps/bureaux_de_vote.svg', 'Paris_2020/{candidate}_b.svg'.format(candidate=candidate), candidaciesData=candidaciesData, scoreMultiplier=scoreMultiplier)
